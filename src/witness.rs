...
///
/// Taken from my PR at: [zkmopro/witnesscalc_adapter](https://github.com/zkmopro/witnesscalc_adapter/pull/11)
/// Note that we use little-endian byte order for all values here.
